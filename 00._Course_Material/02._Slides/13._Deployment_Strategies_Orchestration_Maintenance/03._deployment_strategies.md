...
Two identical environments, where only one is "live" at any time. 

1. Let's say that blue is "live" to begin with.

2. Use the green environment as your staging environment. Once all tests in staging pass, you can switch the traffic to green.
...
1. **Create two applications** (a blue and a green). If we switch from blue to green, we make blue read-only, create a back-up and restore it onto green. 
